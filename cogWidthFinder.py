...
def cog_velocities(velocities, flux, v_helio, low_ind, high_ind, templatebank, rms = 0.0, vel_thresh = 0.75, which_cog = 0, diagnose = False, interp = False, return_vhel = False, resolution = 5.5, return_params = False, agcn = ''):
